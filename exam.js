...
let timer;
let timerDuration = 60; // 5 دقائق للتجربة (300 ثانية)
...
const sectionMark = document.querySelector(".section-mark");
...
function endExam() {
  ...
  popupButton.textContent = `View Results (${score}/${questions.length})`;
